<?php
    ...
    Route::group(['prefix' => 'api-admin','namespace' => 'Admin','middleware' => 'check_admin_login'], function() {
        ...
        Route::get('info','AdminController@info')->name('get.admin.info');
        ...
        Route::group(['prefix' => 'admin'], function(){
            Route::get('','AdminAdminController@index')->name('admin.index');
            Route::get('create','AdminAdminController@create')->name('admin.create');
            Route::post('create','AdminAdminController@store');

            Route::get('update/{id}','AdminAdminController@edit')->name('admin.update');
            Route::post('update/{id}','AdminAdminController@update');

            Route::get('delete/{id}','AdminAdminController@delete')->name('admin.delete');
