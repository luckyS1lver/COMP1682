                ...
                <div class="box-title">
                    <form class="form-inline">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="3" {{ Request::get('status') == 4 ? "selected='selected'" : "" }}>GH không thành công</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu" style="margin-left: -120px;">
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a href="{{ route('admin.action.transaction',['warning', $transaction->id]) }}" ><i class="fa fa-ban"></i>GH không thành công</a>
                                                        </li>
                                                        <li>
